...
const TimeLine = () => {
    return (
        <div className="flex flex-col justify-center divide-y mt-5 xl:mt-5 divide-slate-200">
                    ...
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
								...
								<button
									className="sm:absolute translate-y-0.5 inline-flex items-center justify-center w-25 mb-3 sm:mb-0 align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 border border-gray-900 bg-blue-900 text-white top-12 -left-8 focus:ring focus:ring-gray-300 active:opacity-[0.85] rounded-full">
									<time>
										{data.date}
									</time>
								</button>
